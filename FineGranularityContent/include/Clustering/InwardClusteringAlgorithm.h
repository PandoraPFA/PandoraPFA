/**
 *  @file   PandoraPFANew/FineGranularityContent/include/Clustering/InwardClusteringAlgorithm.h
 * 
 *  @brief  Header file for the clustering algorithm class.
 * 
 *  $Log: $
 */
#ifndef INWARD_CLUSTERING_ALGORITHM_H
#define INWARD_CLUSTERING_ALGORITHM_H 1
...
/**
 *  @brief  InwardClusteringAlgorithm class
 */
class InwardClusteringAlgorithm : public pandora::Algorithm
{
public:
    /**
...
inline InwardClusteringAlgorithm::CustomHitOrder::CustomHitOrder()
{
...
inline bool InwardClusteringAlgorithm::CustomHitOrder::operator()(const pandora::CaloHit *lhs, const pandora::CaloHit *rhs) const
{
...
inline bool InwardClusteringAlgorithm::CustomHitOrder::SortByEnergy(const pandora::CaloHit *lhs, const pandora::CaloHit *rhs) const
{
...
inline bool InwardClusteringAlgorithm::CustomHitOrder::SortByDensityWeight(const pandora::CaloHit *lhs, const pandora::CaloHit *rhs) const
{
...
inline pandora::Algorithm *InwardClusteringAlgorithm::Factory::CreateAlgorithm() const
{
    return new InwardClusteringAlgorithm();
}
