/**
 *  @file   PandoraPFANew/FineGranularityContent/include/PfoConstruction/CLICPfoSelectionAlgorithm.h
 * 
 *  @brief  Header file for an algorithm to select PFOs for CLIC physics studies
 * 
 *  $Log: $
 */
#ifndef CLIC_PFO_SELECTION_ALGORITHM_H
#define CLIC_PFO_SELECTION_ALGORITHM_H 1
...
#endif // #ifndef CLIC_PFO_SELECTION_ALGORITHM_H
