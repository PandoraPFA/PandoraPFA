/**
 *  @file   PandoraPFANew/FineGranularityContent/src/FragmentRemoval/BeamHaloMuonRemovalAlgorithm.cc
 * 
...
bool BeamHaloMuonRemovalAlgorithm::IsBeamHaloMuon(pandora::Cluster * pCluster) const
{
    ...
    if (m_monitoring)
    {
        ...
        if ((isBeamHaloMuon && m_displayRejectedClusters) || (!isBeamHaloMuon && m_displayRetainedClusters))
        {
            ...
            PANDORA_MONITORING_API(VisualizeClusters(&clusterList, "HaloClusters", AUTO));
