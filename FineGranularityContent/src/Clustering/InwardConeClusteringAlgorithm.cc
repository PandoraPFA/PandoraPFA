/**
 *  @file   PandoraPFANew/FineGranularityContent/src/Clustering/InwardConeClusteringAlgorithm.cc
 * 
...
StatusCode InwardConeClusteringAlgorithm::FindHitsInPreviousLayers(PseudoLayer pseudoLayer, CustomSortedCaloHitList *const pCustomSortedCaloHitList,
...
StatusCode InwardConeClusteringAlgorithm::FindHitsInSameLayer(PseudoLayer pseudoLayer, CustomSortedCaloHitList *const pCustomSortedCaloHitList,
    ClusterVector &clusterVector) const
{
...
StatusCode InwardConeClusteringAlgorithm::UpdateClusterProperties(ClusterVector &clusterVector) const
{
...
StatusCode InwardConeClusteringAlgorithm::GetDistanceToHitInSameLayer(CaloHit *const pCaloHit, const CaloHitList *const pCaloHitList,
...
StatusCode InwardConeClusteringAlgorithm::GetConeApproachDistanceToHit(CaloHit *const pCaloHit, const CaloHitList *const pCaloHitList,
...
StatusCode InwardConeClusteringAlgorithm::GetConeApproachDistanceToHit(CaloHit *const pCaloHit, const CartesianVector &clusterPosition,
    const CartesianVector &clusterDirection, float &distance) const
{
    const CartesianVector &hitPosition(pCaloHit->GetPositionVector());
...
StatusCode InwardConeClusteringAlgorithm::RemoveEmptyClusters(ClusterVector &clusterVector) const
{
...
StatusCode InwardConeClusteringAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
    ...
    m_minHitClusterCosAngle = 0.7071f;
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle,
